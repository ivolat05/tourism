...
$(function () {
	let startList = {
		"client": {
			"name": "Клиент Анна",
			"text": `Здравствуйте! У нас скоро долгожданный отпуск, мы бы хотели с вашей помощью запланировать
		...
		"manger": {
			...
			<div class="manager-choice">
						<button class="manager-btn" data-dialog='when' data-choice='when'>
		...
		"actions": {
			"name": "Клиент Анна",
			"text": `Если честно, мы еще не знаем. Наши знакомые рассказывали, что им очень понравилось на Байкале.`,
			"class": 'client'
		},
		"actions-answer": {
			"name": "Менеджер «Билет в отпуск»",
			...
			<div class="manager-choice">
						...
						<button class="manager-btn" data-dialog='budget' data-choice='budget'>
							<span class="manager-btn-text">
							от 90 000 рублей
							</span>
						</button>
		...
		"budget": {
			"name": "Клиент Анна",
			"text": `Ох, это немного дороже, чем мы ожидали.`,
			"class": 'client'
		},
		"budget-answer": {
			"name": "Менеджер «Билет в отпуск»",
			...
			<div class="manager-choice">
						...
						<button class="manager-btn" data-dialog='options' data-choice='options'>
							<span class="manager-btn-text">
							а на какой бюджет отпуска вы рассчитывали?  Уверена, мы сможем подобрать разные варианты.
							</span>
						</button>
					</div>
			`
		...
		"options": {
			"name": "Клиент Анна",
			"text": `Мы бы хотели уложиться в 80000 рублей.`,
			"class": 'client'
		},
		"options-answer": {
			"name": "Менеджер «Билет в отпуск»",
			...
			"text": `Хорошо, поняла вас. Думаю по бюджету вам подойдут такие варианты как ...`,
			"boxBtn": `
			<div class="manager-choice">
						<button class="manager-btn" data-dialog='interes' data-choice='interes'>
							<span class="manager-btn-text">
		...
		"interes": {
			"name": "Клиент Анна",
			"text": `Хорошо, варианты очень интересные.`,
			"class": 'client'
		},
		"interes-answer": {
			"name": "Менеджер «Билет в отпуск»",
			...
			<button class="manager-btn" data-dialog='budget' data-choice='no'>
						...
						<button class="manager-btn" data-dialog='interes-2' data-choice='interes-2' data-number='4'>
							<span class="manager-btn-text">
							А есть ли у вас какие-то особые пожелания? Чего больше хочется?
							</span>
						</button>
		...
		"interes-2": {
			"name": "Клиент Анна",
			"text": `Мы очень любим горы! Хочется провести отпуск поближе к природе, без шумных толп туристов. Интересно будет испытать на себе пешие горные маршруты разной сложности – чтобы увидеть нетронутые леса, чистейшие озёра, ущелья...`,
			"class": 'client'
		},
		"interes-2-answer": {
			"name": "Менеджер «Билет в отпуск»",
		...
		"interes-2-two": {
			"name": "Клиент Анна",
			"text": `Мы отдыхали в прошлом году на Чёрном море, а в этом году хочется чего-то нового. `,
			"class": 'client'
		},
		"interes-2-answer-two": {
			"name": "Менеджер «Билет в отпуск»",
			"class": 'manager',
			"classTwo": '--two',
			"headBtn": `
			...
			"text": `Я поняла! Идеальный вариант для вас – это ...`,
			"boxBtn": `
			<div class="manager-choice">
						...
						<button class="manager-btn" data-dialog='altai' data-choice='altai' data-number='3'>
							<span class="manager-btn-text">
							Алтайские горы
							</span>
						</button>
		...
		"altai-answer": {
			...
			"headBtn": `
			 `,
			"text": `Недельные туры на Алтай начинаются от 60000 рублей на двоих. А самое главное, что Алтай — это неповторимой красоты земля, сочетающая равнины, озёра, реки и горные хребты. Здесь вы прочувствуете настоящую гармонию с первозданной природой!`,
		},
		"altai": {
			"name": "Клиент Анна",
			"text": `Ого, интересно! Мы совсем немного слышали об Алтае.<br> Можно ли там отправиться в поход по горам?`,
			"class": 'client'
		},
		"altai-answer-1": {
			"name": "Менеджер «Билет в отпуск»",
			...
			<button class="manager-btn" data-dialog='budget' data-choice='no'>
						...
						<button class="manager-btn" data-dialog='july' data-choice='july'>
							<span class="manager-btn-text">
							очень много пеших горных маршрутов, думаю вам понравится!
							</span>
						</button>
		...
		"july": {
			"name": "Клиент Анна",
			"text": `А какая там погода в июле?`,
			"class": 'client'
		},
		"july-answer": {
			"name": "Менеджер «Билет в отпуск»",
			...
			<button class="manager-btn" data-dialog='budget' data-choice='no'>
						...
						<button class="manager-btn" data-dialog='attraction' data-choice='attraction'>
							<span class="manager-btn-text">
							много солнечных и теплых дней, вы не разочаруетесь.
							</span>
						</button>
		...
		"attraction": {
			"name": "Клиент Анна",
			"text": `Какие основные достопримечательности на Алтае?`,
			"class": 'client'
		},
		"attraction-answer": {
			"name": "Менеджер «Билет в отпуск»",
			...
			"text": `Достопримечательностей там предостаточно: ...`,
			"boxBtn": `
			<div class="manager-choice">
			<button class="manager-btn" data-dialog='booking' data-choice='booking' data-number='4'>
							<span class="manager-btn-text">
		...
		"booking-answer": {
			...
			"text": `Вас заинтересовало это предложение? Посмотрим варианты?`,
		},
		"booking-two": {
			"name": "Клиент Анна",
			"text": `Да, давайте! Только мы бы не хотели летать ночными рейсами. И можно ещё номер в небольшом отеле с видом на горы? Есть такая возможность? `,
			"class": 'client'
		},
		"booking-answer-two": {
			"name": "Менеджер «Билет в отпуск»",
	...
	function diologRadios() {
		...
		if (chat.children.length <= 2) {
			chat.classList.add('--radius')
		} else {
			if (chat.classList.contains('--radius')) {
				chat.classList.remove('--radius')
			}
